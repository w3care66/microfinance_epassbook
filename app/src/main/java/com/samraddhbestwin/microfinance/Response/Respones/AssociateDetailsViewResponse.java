...
public class AssociateDetailsViewResponse {
...
@Expose
private ResultAssociateDetailsView result;
...
public ResultAssociateDetailsView getResult() {
return result;
}

public void setResult(ResultAssociateDetailsView result) {
this.result = result;
}
